package com.audio.query.audio_query.loaders;
...
import com.audio.query.audio_query.loaders.tasks.AbstractLoadTask;
                ...
                while (artistCursor.moveToNext()) {
                    try {
                        ...
                        for (String artistColumn : PROJECTION) {
                            @SuppressLint("Range") String data = artistCursor.getString(artistCursor.getColumnIndex(artistColumn));
        ...
        private List<String> loadArtistIdsGenre(final String genreName) {
            ...
            if (artistNamesCursor != null) {
                ...
                while (artistNamesCursor.moveToNext()) {
                    try {
                        @SuppressLint("Range") String artistName = artistNamesCursor.getString(artistNamesCursor.getColumnIndex(
